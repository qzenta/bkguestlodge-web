  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-1.5 rounded-full bg-soft-ivory/10 px-2.5 py-1 text-soft-ivory transition hover:bg-soft-ivory/20"
      >
        <span aria-hidden="true" className="text-base leading-none">💱</span>
        <span className="hidden font-utility text-xs font-semibold sm:inline">ZAR</span>
      </button>
