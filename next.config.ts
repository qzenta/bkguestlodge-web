...
const securityHeaders = [
  ...
  { key: "Referrer-Policy", value: "strict-origin-when-cross-origin" },
  {
    ...
    value: `default-src 'self'; script-src ${scriptSrc.join(" ")}; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:; connect-src 'self' https://api.brevo.com https://www.google-analytics.com https://www.clarity.ms https://api.open-meteo.com; frame-ancestors 'self';`,
  },
];
